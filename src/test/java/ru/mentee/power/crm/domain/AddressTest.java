...
class AddressTest {
  ...
  void shouldBeEqual_whenSameData() {
    Address addressOne = new Address("San Francisco", "123 Main St", "94105");
    Address addressTwo = new Address("San Francisco", "123 Main St", "94105");
  ...
  void shouldThrowException_whenCityIsNull() {
    assertThatThrownBy(() -> new Address(null, "123 Main St", "94105")).isInstanceOf(IllegalArgumentException.class);
  }
